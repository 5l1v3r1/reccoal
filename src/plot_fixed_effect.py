...
file_list=glob.glob('../data_fixed_effect/processed_data*.pickle')
params=[]
mT2=[]
mT3=[]
mT4=[]
...
LD_ii = np.where((T2_length<0.3*params[:,li])*(T2_length>100))[0]
...
ax.set_xscale('log')
plt.legend(loc=3)
plt.savefig('../figures/T2_fixed_effect.pdf', bbox_inches='tight', pad_inches=0.4)
...
ax.set_yscale('log')
ax.set_xscale('log')
plt.savefig('../figures/TMRCA_fixed_effect.pdf', bbox_inches='tight', pad_inches=0.4)
...
# ax.set_yscale('log')
# ax.set_xscale('log')
# plt.savefig('../figures/T3_fixed_effect.pdf')
...
# ax.set_yscale('log')
# ax.set_xscale('log')
# plt.savefig('../figures/T4_fixed_effect.pdf')
...
# ax.set_yscale('log')
# ax.set_xscale('log')
# plt.savefig('../figures/length_fixed_effect.pdf')
...
plt.savefig('../figures/LD_fixed_effect.pdf', bbox_inches='tight', pad_inches=0.4)
...
plt.xlim([-8,8])
plt.legend(loc=1)
plt.savefig('../figures/SFS_fixed_effect.pdf'  , bbox_inches='tight', pad_inches=0.4)       
...
##########################
plt.figure()
plt.title(r'color = $\log_{10}(N{\sigma}_b)$')
for i in range(len(SFS)):
    plt.plot(np.log(SFS[i][0]/(1-SFS[i][0])), 
...
ax=plt.gca()
ax.set_yscale('log')
plt.savefig('../figures/SFS_sel_fixed_effect.pdf'  , bbox_inches='tight', pad_inches=0.4)      
